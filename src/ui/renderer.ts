...
export class BoardRenderer {
  ...
  render(board: Board, selection: SelectionView | null, floats: FloatingText[]): void {
    const { ctx } = this;
  ...
  private drawSelection(sel: SelectionView): void {
    ...
    const stroke = sel.valid ? COLORS.selectValid : COLORS.selectDrag;
    const fill = sel.valid ? COLORS.selectValidFill : COLORS.selectDragFill;
